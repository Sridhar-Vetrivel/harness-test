'''
Schema constrained output (Claude Code)
Verify the file-write schema pipeline produces a validated pydantic model.
'''
...
async def test():
    ...
    result = await agent.harness(
        "Return message='Hello world' and lucky_number=Who are you.",
        schema=Greeting
    )
